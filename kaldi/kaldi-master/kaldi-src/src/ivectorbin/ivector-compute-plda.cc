    ...
    for (; !spk2utt_reader.Done(); spk2utt_reader.Next()) {
      ...
      if (ivectors.size() == 0) {
        ...
        double weight = 1.0; // The code supports weighting but
                             ...
                             // level yet.
        // 保存了各spker 的 mean  协方差, 以及对应spker 的 utt_cnt
