...
//                        -nj 8  --cmd run.pl       --srcdir exp/tri4b_dnn    --config decode.config   --acwt=0.1
//  exp/tri4b/graph_word上次训练输出结果    test_fbank        输出结果 ---exp/tri4b_dnn/decode_test_word
...
void decode_sh(){
  ...
  // graphdir=$1     // exp/tri4b/graph_word  词图目录?
  // data=$2         // fbank                 特征输入
  // dir=$3          // dir ---- exp/tri4b_dnn/decode_test_word  目标输出路径
