...
# 生成 lexicon1_raw_nosil.txt:  word  phones
...
# 将silence_phones 作为 word  phones  > lexicon2_raw.txt
...
# 向lexicon3_expand.txt 中
# 追加 word:mm  phones:m 以及 word:<unk>  phone:oov
# 加入到 lexicon4_extra.txt
