...
# 准备扰动数据
# 1 扰动data/train => data/train_sp
# 2 计算 mfcc_pitch 特征 => mfcc_perturbed
# 3 计算cmvn => mfcc_perturbed
...
# 1 cp data/train_sp => data/train_sp_hires
# 2 扰动数据  data/train_sp_hires
# 3 计算mfcc_pitch特征 => mfcc_perturbed_hires
# 4 计算cmvn => mfcc_perturbed_hires
# 5 剔除pitch => data/train_sp_hires_nopitch
# 6 计算cmnv => mfcc_perturbed_hires
if [ $stage -le 3 ]; then
